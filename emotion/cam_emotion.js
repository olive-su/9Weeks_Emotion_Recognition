...
import "./cam_emotion.css"; // 비디오 화면 내 draw 이미지 조정
import AccountPage from "../account";// detection 전달 
...
function CamEmotion() {
  ...
  const handleVideoOnplay = () => {
    setInterval(async () => {
      ...
      console.log(detections[0]); //[0].expressions
